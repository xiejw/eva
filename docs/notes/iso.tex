...
\secc 19.3.1 Argument substitution [cpp.subst]
...
\secc 19.3.2 The \symbol{\#} operator [cpp.stringize]
...
\secc 19.3.3 The \symbol{\#\#} operator [cpp.concat]
...
{\sl Personal note:} This is the reason why to expand \symbol{\_\_COUNTER\_\_},
...
\secc 19.3.4 Rescanning and further replacement [cpp.rescan]
